...
const Banner = ({query,handleInputChange}) => {
  ...
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14'>
      ...
      <p className='text-lg text-black/70 mb-8'>Thousands of jobs in computer, engineering, and technology sectors are waiting for you</p>

      <form>
        <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
          <div className='flex mg:rounded-s-md rounded shadow-sm ring-1 ring-gray-300 focus-within:ring-2 focus-within:inset focus-within:ring-indigo-600 md:w-1/2 w-full'>
            <input
              type='text'
              name='title'
              id='title'
          ...
          <div className='flex mg:rounded-s-none rounded shadow-sm ring-1 ring-gray-300 focus-within:ring-2 focus-within:inset focus-within:ring-indigo-600 md:w-1/3  w-full'>
            <input
              type='text'
              name='title'
              id='title'
